        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight flex items-center gap-2">
              Charlie
              {isDemoMode && (
                <span className="text-[10px] bg-amber-400 text-amber-950 px-2 py-0.5 rounded-full font-black uppercase tracking-tighter shadow-sm border border-amber-300/50">
                  Demo
                </span>
              )}
            </h1>
          ...
          {isLoading && (
            ...
            >
              <div className="flex gap-3 items-center bg-white border border-cyan-50 p-4 rounded-2xl rounded-tl-none shadow-sm">
                ...
                <span className="text-sm text-zinc-500 font-medium">Sedang berfikir...</span>
              </div>
            </motion.div>
          )}
